...
export default function MegaHolder() {
  return (
        ...
        <div className='space-y-4 sm:py-8 sm:px-8 px-3 py-8 '>
          <div className='flex gap-2 items-center'>
            ...
            <div>
              <p className='text-[#0141AC] text-2xl font-bold '>مگاهلدر</p>
            </div>
          </div>
          <div>
        ...
        <div>
            <p className='text-center mt-4 text-sm leading-5 text-[#777] font-bold px-3'>
                ارتباط کامل شبکه سهامداری در بازار سرمایه 
            </p>
        </div>
        <div className=''>
    ...
    <div className='bgWatchList  space-y-4 flex flex-col  items-center'>
        ...
        <div>
            <p className='text-center  mt-4 text-sm leading-5 text-[#777] font-bold px-3'>
                نمایش عملکرد درصدی ها در صنایع   
            </p>
        </div>
        <div className=''>
            <p className='text-center text-sm leading-5 text-[#777] mb-4 px-3'> 
    ...
    <div className='bgWatchList  space-y-4 flex flex-col  items-center'>
        ...
        <div>
            <p className='text-center  mt-4 text-sm leading-5 text-[#777] font-bold px-3'>
                ریز ارتباطات سهامداری بازیگران حقوقی و حقیقی بازار سرمایه 
            </p>
        </div>
        <div className=''>
            <p className='text-center text-sm leading-5 text-[#777] mb-4 px-3'>
