                    ...
                    <table className="w-full text-sm text-center border-spacing-y-3 border-separate table-auto overflow-scroll">
                        <thead className="text-sm text-white font-semibold ">
                            <tr className='text-[#0141AC] border border-[#D3B9DC] '>
                                <th scope="col" className="px-4 md:px-12 py-3 rounded-r-2xl border-y border-r border-[#D3B9DC] ">
                                      نماد
                                </th>
                                <th scope="col" className="px-4 md:px-12 py-3 border-y border-[#D3B9DC]">
                                    آخرین قیمت
                                </th>
                                <th scope="col" className="px-4 md:px-12 py-3 border-y border-[#D3B9DC]">
                                    بازده
                                ...
                                <th scope="col" className="px-4 md:px-12 py-3 rounded-l-2xl border-y border-l border-[#D3B9DC] ">
                                    ارزش معاملات
                                </th>
                            </tr>
                        </thead>
                        <tbody className='text-[#777] text-sm '>
                            <tr className="bg-[#F8F8F8] ">
                                <td className="px-4 md:px-12 py-3 rounded-r-2xl">
                                ...
                                <td className="px-4 md:px-12 py-3 text-[#D64937]">
                                    0.6%
                                </td>
                                <td className="px-4 md:px-12 py-3 text-[#2BC42C]">
                                     26%
                                </td>
                                <td dir='ltr' className="px-4 md:px-12 py-3 rounded-l-2xl">
                                     1.64 T
                                </td>
                            </tr>
                            <tr className="bg-[#F8F8F8] ">
